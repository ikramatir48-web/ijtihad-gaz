      ...
      <div style={{ maxWidth: 480, width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>
            Bienvenue ! Complétez votre compte pour continuer.
          </p>
        </div>
            ...
            <div key={n} className="flex items-center gap-3">
              ...
              <span
                style={{
                  ...
                  fontWeight: 500,
                  color:
                    step >= Number(n) ? 'var(--text)' : 'var(--text-muted)',
                }}
              >
                {label}
              </span>
        ...
        <div className="card">
          {step === 1 && (
            <>
              ...
              >
                ...
                <strong>une majuscule</strong>, <strong>un chiffre</strong>.
              </div>
              ...
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    value={pwd.nouveau}
                    onChange={(e) =>
                      setPwd((p) => ({ ...p, nouveau: e.target.value }))
                    }
                ...
                {pwd.nouveau && (
                  <div
                    style={{
                      marginTop: 6,
                      fontSize: 12,
                      color: pwdErr ? 'var(--danger)' : 'var(--success)',
                    }}
                  >
              ...
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    onChange={(e) =>
                      setPwd((p) => ({ ...p, confirmation: e.target.value }))
                    }
                    style={{ paddingRight: 42 }}
                  />
                  <button
              ...
              <button
                ...
                disabled={saving || !!pwdErr || !pwd.nouveau}
              >
          ...
          {step === 2 && (
            <>
              ...
              >
                Ces informations apparaîtront sur vos bons de livraison et
                factures.
              </p>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={profil.nom}
                  onChange={(e) =>
                    setProfil((p) => ({ ...p, nom: e.target.value }))
                  }
                />
              </div>
              <div className="flex gap-3">
                <div className="form-group flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProfil((p) => ({ ...p, telephone: e.target.value }))
                    }
                  />
                </div>
                <div className="form-group flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProfil((p) => ({ ...p, adresse: e.target.value }))
                    }
                  />
                </div>
              </div>
              <div className="form-group">
                ...
                <input
                  className="form-input"
                  value={profil.nom_societe}
                  onChange={(e) =>
                    setProfil((p) => ({ ...p, nom_societe: e.target.value }))
                  }
                />
              </div>
              <div className="flex gap-3">
                <div className="form-group flex-1">
                  ...
                  <input
                    ...
                    value={profil.ice}
                    onChange={(e) =>
                      setProfil((p) => ({ ...p, ice: e.target.value }))
                    }
                  />
                </div>
                <div className="form-group flex-1">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setProfil((p) => ({ ...p, activite: e.target.value }))
                    }
                  >
              ...
              {profil.activite === 'Autre' && (
                <div className="form-group">
                  ...
                  <input
                    className="form-input"
                    value={profil.activite_autre}
                    onChange={(e) =>
                      setProfil((p) => ({
                        ...p,
                        activite_autre: e.target.value,
                      }))
                    }
                  />
                </div>
