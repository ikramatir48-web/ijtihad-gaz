                ...
                {livreurs.map((l) => (
                  <tr key={l.id} style={{ opacity: l.actif ? 1 : 0.5 }}>
                    ...
                    <td>
                      <span
                        className={`badge ${
                          l.actif ? 'badge-green' : 'badge-gray'
                        }`}
                      >
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>
                {editLivreur ? 'Modifier le livreur' : 'Ajouter un livreur'}
              </h3>
              <button
                className="btn btn-ghost btn-sm btn-icon"
            ...
            <div className="modal-body">
              ...
              <div className="flex gap-3">
                <div className="form-group flex-1">
                  <label className="form-label">
                    CIN <span className="text-muted">(optionnel)</span>
                  </label>
                  <input
                    className="form-input"
                    value={form.cin}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    update('immatriculation', e.target.value.toUpperCase())
                  }
